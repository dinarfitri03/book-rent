    ...
    <div class="mt-5 w-50">
        ...
        <form action="/book-edit/{{ $book->slug }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="code" id="code" class="form-control" placeholder="Book's Code" value="{{ $book->book_code }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @if ($book->cover!='')
                    <img src="{{ asset('public/storage/cover/'.$book->cover) }}" alt="" width="150px">
                @else
                    <img src="{{ asset('images/cover-not-found.jpg') }}" alt="" width="150px">
                @endif
            </div>
            <div class="mb-3">
